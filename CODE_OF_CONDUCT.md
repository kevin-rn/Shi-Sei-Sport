...
This Code of Conduct applies within all project spaces, including the repository, issue tracker, pull requests, and any other communication channels used for the project.

## Enforcement

Instances of abusive, harassing, or otherwise unacceptable behavior may be reported to the project maintainer via the contact information on their [GitHub profile](https://github.com/kevin-rn).
