    ...
    <PageWrapper maxWidth="max-w-5xl">
      ...
      <div className="bg-gray-50 border border-gray-200 rounded-lg p-8 mb-12">
        <div className="flex items-start gap-4">
          ...
          <div>
            <h2 className="text-lg font-bold text-judo-dark mb-3">{t('privacy.intro.title')}</h2>
      ...
      <section className="mb-12">
        <div className="flex items-center gap-3 mb-6">
          ...
          <h2 className="text-xl font-bold text-judo-dark">{t('privacy.collection.title')}</h2>
        </div>
      ...
      <section className="mb-12">
        <div className="flex items-center gap-3 mb-6">
          ...
          <h2 className="text-xl font-bold text-judo-dark">{t('privacy.usage.title')}</h2>
        </div>
        <div className="bg-white border border-gray-100 rounded-lg p-6 shadow-sm">
      ...
      <section className="mb-12">
        <div className="flex items-center gap-3 mb-6">
          ...
          <h2 className="text-xl font-bold text-judo-dark">{t('privacy.protection.title')}</h2>
        </div>
        <div className="bg-white border border-gray-100 rounded-lg p-6 shadow-sm">
      ...
      <section className="mb-12">
        <div className="flex items-center gap-3 mb-6">
          ...
          <h2 className="text-xl font-bold text-judo-dark">{t('privacy.rights.title')}</h2>
        </div>
        <div className="bg-white border border-gray-100 rounded-lg p-6 shadow-sm">
      ...
      <section className="mb-12">
        <div className="flex items-center gap-3 mb-6">
          ...
          <h2 className="text-xl font-bold text-judo-dark">{t('privacy.cookies.title')}</h2>
        </div>
        <div className="bg-white border border-gray-100 rounded-lg p-6 shadow-sm">
          <p className="text-judo-gray leading-relaxed mb-4">
