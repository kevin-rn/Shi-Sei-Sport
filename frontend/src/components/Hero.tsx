...
export const Hero = () => {
  ...
  return (
    <section className="relative h-[70vh] flex items-end md:items-center -mt-20 pt-20">
      ...
      {/* Text Content */}
      <div className="container mx-auto px-6 pb-8 md:pb-0 pt-8 md:pt-0 relative z-10 text-white max-w-4xl [text-shadow:0_2px_8px_rgba(0,0,0,0.6)]">
